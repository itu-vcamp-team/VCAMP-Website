...
const BlogSection = () => {
  ...
  const translations = {
    tr: {
      blog: 'Blog',
      blogSubtitle: 'Projelerimiz ve gelişim sürecimiz hakkında güncel haberler',
    ...
    en: {
      blog: 'Blog',
      blogSubtitle: 'Latest news about our projects and development process',
    ...
    <section id="blog" className="blog-section">
      <div className="blog-container">
        <div className="blog-header">
          <h2 className="blog-title">{t.blog}</h2>
        ...
        <div className="blog-footer">
          <button 
            className="blog-view-more-button"
