import { Renderer, Program, Mesh, Color, Triangle } from 'https://cdn.jsdelivr.net/npm/ogl@1.0.3/dist/ogl.mjs';
...
export class GalaxyBackground {
    constructor(containerId, options = {}) {
        ...
        // Default options matching React props
        this.options = {
            focal: [0.5, 0.5],
            rotation: [1.0, 0.0],
            starSpeed: 0.3, // prop value
            density: 1.2, // prop value
            hueShift: 80, // prop value
            speed: 0.4, // prop value
            glowIntensity: 0.1, // prop value
            saturation: 0.1, // prop value
            mouseRepulsion: false, // prop value
            repulsionStrength: 1.5, // prop value
            twinkleIntensity: 0.1, // prop value
            rotationSpeed: 0, // prop value
            autoCenterRepulsion: 2, // prop value
            transparent: true,
            mouseInteraction: false, // prop value
            ...options
        };
        ...
        this.smoothMouseActive = 0.0; // uMouseActiveFactor default
    ...
    init() {
        ...
        if (this.options.mouseInteraction) {
            this.ctn.addEventListener('mousemove', this.handleMouseMove.bind(this));
            this.ctn.addEventListener('mouseleave', this.handleMouseLeave.bind(this));
        }
